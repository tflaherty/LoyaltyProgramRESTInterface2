...
public interface PersonRepository extends PagingAndSortingRepository<Person, Long> {
	...
	List<Person> findByCustomerCodeDivisionNameCompanyName(@Param("customerCode") String customerCode, @Param("divisionName") String divisionName, @Param("companyName") String companyName);
